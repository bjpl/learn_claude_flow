 ...
 * Main layout wrapper with header, navigation, and outlet for routes
 */
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <kbd className="hidden md:inline-block px-2 py-1 text-xs bg-gray-100 rounded border border-gray-300">
                Ctrl+K
              </kbd>
            </button>
